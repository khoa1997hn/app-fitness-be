...
return [
    ...
    */
    ...
    'contains' => 'Trường :attribute thiếu trường bắt buộc :required.',
    ...
    */
    ...
    'custom' => [
        'phone' => [
            'regex' => 'Số điện thoại không đúng định dạng. Vui lòng nhập số điện thoại hợp lệ (7-15 chữ số, có thể bắt đầu bằng dấu +).',
        ],
    ],
